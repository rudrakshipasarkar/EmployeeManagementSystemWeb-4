							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									if (isset($employees_details)) {
										// echo $employees_details['first_name'];
									?>
									<input name="full_name" type="text" class="form-control wizard-required mt-3 mb-3" readonly autocomplete="off" value="<?php echo $employees_details[0]['first_name']; ?> <?php echo ($employees_details[0]['middle_name']); ?> <?php echo ($employees_details[0]['last_name']); ?> ">
								</div>
