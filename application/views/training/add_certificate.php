...
<body>
<div class="fluid-container add_certificate-page mt-5">
	<div class="card card-1">
		<div class="card-body">
			<h5 class="card-title">Add training Certificate</h5>
	...
	<div class="card card-2">
		<div class="card-body"> 
			...
			<form method="post" action="<?php echo base_url() . 'Training/TrainingController/post_add_training'?>">
				<section>
    ...
    <div class="row px-3">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="form-group">
                ...
                <input name="apply_letter" type="file" class="form-control mt-3 mb-3" required="true"
                    autocomplete="off">
            </div>
        </div>
					...
					<div class="row  px-3">
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
                                ...
                                <button type="submit" onclick = "alert('Your form is submitted!')" class="btn apply-btn mt-3 mb-3" name="upload" id="upload" 
                  style="
                      background-color: #524d7d;
                      border-color: #524d7d;
                      color:white;
                      font-weight: 500;
                      font-size: 1rem;"> Upload Certificate</button>
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	var container = document.querySelector(".add_certificate-page")
