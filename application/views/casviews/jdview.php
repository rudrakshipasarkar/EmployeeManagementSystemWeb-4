            ...
            <div class="tab-pane active" id="Cas_Applications">
                ...
                <table class="table table-bordered">
                  ...
                  <?php $i = 1; foreach($applications as $applications): ?>
                    <?php if($applications->status == '2' || $applications->status == '3' || $applications->status == '4'): ?>
                    <tr>
                        ...
                        <?php if($applications->status == '2'): ?>
                            <a class="text-info" style="margin-right: 10px;padding: 10px;font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('cascontroller/formcontroller/viewDetailsjd/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i>View Form</a>
                        <?php elseif($applications->status == '4'):?>
                            <a class="text-info" style="font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('cascontroller/formcontroller/viewDetailsjd/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i></a>
