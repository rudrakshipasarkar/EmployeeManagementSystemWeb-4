...
<div class="container pb-4">
	...
	<div class="d-grid gap-2 d-md-flex justify-content-center mb-4">
        <?php if($row->status == '1'): ?>
  		    <a class="btn btn-success" style="width:125px;" type="button" href="<?= base_url('cascontroller/formcontroller/updatedto/'.$row->Id.'/'.$row->Email);?>">Approve</a>
            <a class="btn btn-danger" style="width:125px;"  type="button" href="<?= base_url('cascontroller/formcontroller/dtoreject/'.$row->Id);?>">Reject</a>
        ...
        <?php else:?>
            ...
            <a class="btn btn-danger" style="width:125px;"  type="button" href="<?= base_url('cascontroller/formcontroller/revertDto/'.$row->Id) ?>">Revert</a>
        <?php endif ?>
	</div>
</div>
<?php endforeach;?>
