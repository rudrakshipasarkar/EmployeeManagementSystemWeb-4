...
<div class="container pb-4">
	...
	<div class="d-grid gap-2 d-md-flex justify-content-center mb-4">
        <?php if($row->status == '0'): ?>
            ...
            <a class="btn btn-danger" style="width:125px;"  type="button" href="<?= base_url('cascontroller/formcontroller/principalreject/'.$row->Id);?>">Reject</a>
        ...
        <?php else:?>
            ...
            <a class="btn btn-danger" style="width:125px;"  type="button" href="<?= base_url('cascontroller/cascontroller/formcontroller/revertPrincipal/'.$row->Id)?>">Revert</a>
        <?php endif ?>
	</div>
</div>
<?php endforeach;?>
